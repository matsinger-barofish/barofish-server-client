...
public class ProductExcelService {
    ...
    public ProductExcelData convertRow2ProductData(Row row) throws Exception {
        ...
        Optional<Category> parentCategory = categoryService.findOptionalCategoryWithName(parentCategoryName);
        ...
        Optional<Category>
                category =
                categoryService.findOptionalCategoryWithName(categoryName, parentCategory.get().getId());
