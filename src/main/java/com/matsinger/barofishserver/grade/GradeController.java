...
public class GradeController {
    ...
    public ResponseEntity<CustomResponse<List<Grade>>> selectGrade() {
        ...
        try {
            List<Grade> grades = gradeService.selectGradeList();
    ...
    public ResponseEntity<CustomResponse<Grade>> selectGrade(@PathVariable("id") Integer id) {
        ...
        try {
            Grade grade = gradeService.selectGrade(id);
    ...
    public ResponseEntity<CustomResponse<Grade>> addGrade(@RequestHeader(value = "Authorization") Optional<String> auth,
        ...
        try {
            ...
            if (data.minOrderPrice == null) return res.throwError("최소 주문 금액을 입력해주세요.", "INPUT_CHECK_REQURIED");
            ...
            grade = gradeService.addGrade(grade);
            res.setData(Optional.ofNullable(grade));
            return ResponseEntity.ok(res);
        } catch (Exception e) {
            return res.defaultError(e);
...
//    public ResponseEntity<CustomResponse<Boolean>> deleteGrade(@RequestHeader(value = "Authorization") Optional<String> auth,
//                                                               @PathVariable("id") Integer id) {
