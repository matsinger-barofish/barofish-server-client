package com.matsinger.barofishserver.productinfo.api;

import com.matsinger.barofishserver.jwt.JwtService;
import com.matsinger.barofishserver.jwt.TokenAuthType;
import com.matsinger.barofishserver.jwt.TokenInfo;
import com.matsinger.barofishserver.productinfo.application.ProductInfoService;
...
public class ProductInfoController {
    ...
    public ResponseEntity<CustomResponse<ProductType>> addProductType(
    ...
    public ResponseEntity<CustomResponse<ProductType>> updateProductType(
            @RequestHeader(value = "Authorization") Optional<String> auth,
    ...
    public ResponseEntity<CustomResponse<Boolean>> deleteProductTypes(
            @RequestHeader(value = "Authorization") Optional<String> auth,
        ...
        try {
            if (data.ids == null)
                return res.throwError("아이디를 입릭해주세요.", "INPUT_CHECK_REQUIRED");
    ...
    public ResponseEntity<CustomResponse<ProductLocation>> addProductLocation(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @RequestPart(value = "data") AddProductInfoReq data) {
    ...
    public ResponseEntity<CustomResponse<ProductLocation>> updateProductLocation(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @PathVariable("id") Integer id,
            @RequestPart(value = "data") AddProductInfoReq data) {
        CustomResponse<ProductLocation> res = new CustomResponse<>();
    ...
    public ResponseEntity<CustomResponse<Boolean>> deleteProductLocations(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @RequestPart(value = "data") DeleteProductInfoReq data) {
        CustomResponse<Boolean> res = new CustomResponse<>();
        Optional<TokenInfo> tokenInfo = jwt.validateAndGetTokenInfo(Set.of(TokenAuthType.ADMIN), auth);
    ...
    public ResponseEntity<CustomResponse<ProductProcess>> addProductProcess(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @RequestPart(value = "data") AddProductInfoReq data) {
    ...
    public ResponseEntity<CustomResponse<ProductProcess>> updateProductProcess(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @PathVariable("id") Integer id,
            @RequestPart(value = "data") AddProductInfoReq data) {
        CustomResponse<ProductProcess> res = new CustomResponse<>();
    ...
    public ResponseEntity<CustomResponse<Boolean>> deleteProductProcesss(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @RequestPart(value = "data") DeleteProductInfoReq data) {
        CustomResponse<Boolean> res = new CustomResponse<>();
        Optional<TokenInfo> tokenInfo = jwt.validateAndGetTokenInfo(Set.of(TokenAuthType.ADMIN), auth);
    ...
    public ResponseEntity<CustomResponse<ProductUsage>> addProductUsage(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @RequestPart(value = "data") AddProductInfoReq data) {
    ...
    public ResponseEntity<CustomResponse<ProductUsage>> updateProductUsage(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @PathVariable("id") Integer id,
            @RequestPart(value = "data") AddProductInfoReq data) {
        CustomResponse<ProductUsage> res = new CustomResponse();
    ...
    public ResponseEntity<CustomResponse<Boolean>> deleteProductUsages(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @RequestPart(value = "data") DeleteProductInfoReq data) {
        CustomResponse<Boolean> res = new CustomResponse();
        Optional<TokenInfo> tokenInfo = jwt.validateAndGetTokenInfo(Set.of(TokenAuthType.ADMIN), auth);
    ...
    public ResponseEntity<CustomResponse<ProductStorage>> addProductStorage(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @RequestPart(value = "data") AddProductInfoReq data) {
    ...
    public ResponseEntity<CustomResponse<ProductStorage>> updateProductStorage(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @PathVariable("id") Integer id,
            @RequestPart(value = "data") AddProductInfoReq data) {
        CustomResponse<ProductStorage> res = new CustomResponse();
    ...
    public ResponseEntity<CustomResponse<Boolean>> deleteProductStorages(
            @RequestHeader(value = "Authorization") Optional<String> auth,
            @RequestPart(value = "data") DeleteProductInfoReq data) {
        CustomResponse<Boolean> res = new CustomResponse();
        Optional<TokenInfo> tokenInfo = jwt.validateAndGetTokenInfo(Set.of(TokenAuthType.ADMIN), auth);
